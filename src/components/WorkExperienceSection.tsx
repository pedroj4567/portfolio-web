        ...
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical h-[600px] overflow-y-scroll ">
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end ">
              ...
              <div className="text-lg font-black ">SmartCompliance</div>
              <div className="text-[14px] font-medium flex  items-center md:justify-end mb-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <p className="text-sm ">
                ...
                optimizadas, junto con PostgreSQL para el manejo de bases de
                datos relacionales y servicios AWS como Cognito, Lambda y RDS,
                además de realizar análisis y optimización de flujos para
          ...
          <li>
            ...
            <div className="timeline-end mb-10 md:text-end">
              <time className="font-mono italic">2024-2025</time>
              <div className="text-lg font-black ">SmartCompliance</div>
              <div className="text-[14px] font-medium flex md:justify-end items-center mb-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
          ...
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              <time className="font-mono italic">2024-2025</time>
              <div className="text-lg font-black ">SmartCompliance</div>
              <div className="text-[14px] font-medium flex  md:justify-end mb-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
